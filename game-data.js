(function () {
  ...
  var spaceCharacters = [
    ...
    },
    {
      ...
      colors: { primary: "#2B3348", secondary: "#FF8A3D", accent: "#8DF6FF" },
      boostColor: "#FF8A3D",
    ...
    },
    {
      ...
      colors: { primary: "#A78BFA", secondary: "#34F0B2", accent: "#F8F7FF" },
      boostColor: "#A78BFA",
    ...
    },
    {
      ...
      colors: { primary: "#4FC3FF", secondary: "#14223B", accent: "#FFB020" },
      boostColor: "#4FC3FF",
  ...
  var spaceMachines = [
    ...
    },
    {
      ...
      type: "Heavy",
      className: "Heavy",
      colors: { body: "#2B3348", trim: "#FF8A3D", glow: "#8DF6FF", primary: "#2B3348", secondary: "#FF8A3D", accent: "#8DF6FF" },
      boostColor: "#FF8A3D",
    ...
    },
    {
      ...
      type: "Light",
      className: "Light",
      colors: { body: "#A78BFA", trim: "#34F0B2", glow: "#F8F7FF", primary: "#A78BFA", secondary: "#34F0B2", accent: "#F8F7FF" },
      boostColor: "#A78BFA",
    ...
    },
    {
      ...
      type: "Balanced",
      className: "Balanced",
      colors: { body: "#4FC3FF", trim: "#14223B", glow: "#FFB020", primary: "#4FC3FF", secondary: "#14223B", accent: "#FFB020" },
      boostColor: "#4FC3FF",
  ...
  var spaceCourse = {
    ...
    palette: { road: "#E9F4FF", roadEmissive: "#BFD7FF", railLeft: "#F8FDFF", railRight: "#E8C66A", centerLine: "#DDF6FF", shortcut: "#BFD7FF", dust: "#DCE9F7", warning: "#E8C66A", sky: "#071326", fog: "#0A172B", structure: "#C9D6E4", boost: "#F5D77A" },
  ...
  window.AURORA_GAME_DATA.version = "0.3.0-experience-v41";
